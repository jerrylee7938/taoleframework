...
/**
 * 该返回策略与ReturnResult的区别是采用了com.alibaba.fastjson.JSONObject
 * @author Administrator
 *
 */
public class ReturnResultV2 {
    ...
    public ReturnResultV2() {
        super();
    }

    public ReturnResultV2(String code, String desc) {
        this.code = code;
        this.desc = desc;
    }

    public ReturnResultV2(String code, String desc, Object object) {
        this.code = code;
        this.desc = desc;
        this.object = object;
    }

    public ReturnResultV2(String[] code, Object object) {
        this.code = code[0];
        this.desc = code[1];
        this.object = object;
    }
    ...
    // jerry added
    public ReturnResultV2(String code, HttpServletResponse response) {
        this.code = code;
    ...
    public ReturnResultV2(String[] code) {
        this.code = code[0];
        this.desc = code[1];
    }
    
    public ReturnResultV2(String[] code,int pos) {
        this.code = code[pos];
        this.desc = code[pos+1];
    }
