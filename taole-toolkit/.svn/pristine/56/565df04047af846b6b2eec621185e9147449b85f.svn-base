 ...
 * @author Rory
 * @date Jun 14, 2012
 * @version $Id: HSSFExcelHtmlHelper.java 16 2014-01-17 17:58:24Z yedf $
 */
public class HSSFExcelHtmlHelper implements ExcelHtmlHelper {
    ...
    public HSSFExcelHtmlHelper(HSSFWorkbook wb) {
        this.wb = wb;
