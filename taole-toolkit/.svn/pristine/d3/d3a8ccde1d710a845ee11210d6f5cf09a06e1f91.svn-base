...
public class ThreeDES {
	 ...
	 * @return 加密后密文
	 */
	public static String encrypt(String str, String base64Key, String iv, String algorithm) {
	 ...
	 * @return 解密后密码
	 */
	public static String decrypt(String password, String base64Key, String iv, String algorithm) {
	...
	public static void main(String[] args) throws Exception {
		...
		String coderStr = ThreeDES.encrypt(str, key);
		System.out.println("encrypt:" + coderStr);
		String decrypt = ThreeDES.decrypt(coderStr, key);
