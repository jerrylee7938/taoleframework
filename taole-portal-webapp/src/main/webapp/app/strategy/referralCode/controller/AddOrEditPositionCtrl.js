Ext.define('Taole.strategy.referralCode.controller.AddOrEditPositionCtrl', {
    extend: 'Ext.app.Controller',
    views: [
    	"Taole.strategy.referralCode.view.AddOrEditPositionWindow"
    ],
    refs: [
    {
    	 ref: 'window',
    ...
    init: function() {  
    	if(Taole.strategy.referralCode.controller.AddOrEditPositionCtrl.isInit)return;

    	Taole.strategy.referralCode.controller.AddOrEditPositionCtrl.isInit = true;
