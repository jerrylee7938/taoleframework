Ext.define('Taole.strategy.marketingSubject.controller.AddOrEditPositionCtrl', {
    extend: 'Ext.app.Controller',
    views: [
    	"Taole.strategy.marketingSubject.view.AddOrEditPositionWindow"
    ],
    refs: [
    {
    	 ref: 'window',
    ...
    init: function() {  
    	if(Taole.strategy.marketingSubject.controller.AddOrEditPositionCtrl.isInit)return;

    	Taole.strategy.marketingSubject.controller.AddOrEditPositionCtrl.isInit = true;
